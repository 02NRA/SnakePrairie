 ...
 *
 */
package net.mcreator.thenewworld;
...
@Mod("the_new_world")
public class TheNewWorldMod {
	public static final Logger LOGGER = LogManager.getLogger(TheNewWorldMod.class);
	public static final String MODID = "the_new_world";
